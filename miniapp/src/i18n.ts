...
const translations = {
  ...
  cashLoanHint: { uz: 'Bu summa asosiy balansga tushadi', ru: 'Эта сумма поступит на основной баланс', en: 'This amount is added to the main balance' },
  creditPurchaseHint: { uz: "Bu qarz faqat chiqim uchun manba bo'ladi", ru: 'Этот долг используется только как источник расходов', en: 'This debt can only be used as an expense source' },
  noDebtSources: { uz: "Chiqim uchun qarz manbasi yo'q", ru: 'Нет доступных долгов для расходов', en: 'No debt sources available for expenses' },
