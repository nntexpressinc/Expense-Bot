...
const translations = {
  ...
  usersOverview: { uz: "Foydalanuvchilar ko'rinishi", ru: 'Обзор пользователей', en: 'Users overview' },
  recentAttendance: { uz: "So'nggi davomatlar", ru: 'Последняя посещаемость', en: 'Recent attendance' },
  attendanceSummary: { uz: 'Umumiy davomat', ru: 'Общая посещаемость', en: 'Attendance summary' },
  activeDebts: { uz: 'Faol qarzlar', ru: 'Активные долги', en: 'Active debts' },
  ...
  salary: { uz: 'Oylik summa', ru: 'Месячный оклад', en: 'Monthly salary' },
  totalMarked: { uz: 'Jami belgilangan', ru: 'Всего отмечено', en: 'Total marked' },
  ...
  actingAs: { uz: 'User sifatida ishlayapsiz', ru: 'Режим пользователя', en: 'Acting as user' },
  actingAsHint: { uz: 'Admin:', ru: 'Админ:', en: 'Admin:' },
  exitImpersonation: { uz: 'Chiqish', ru: 'Выйти', en: 'Exit' },
  switchAsUser: { uz: 'User sifatida ochish', ru: 'Открыть как пользователь', en: 'Open as user' },
